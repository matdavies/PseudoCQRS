	...
	public abstract class BasePropertyValueProvider
	{
		...
		public object ConvertValue( string value, Type propertyType )
		{
			...
			if ( propertyType == typeof ( DateTime ) )
			{
				...
				var possibleFormats = new string[] { "dd/MM/yyyy", "dd MMM yyyy", "HH:mm", "hh:mm tt", "h:mm tt", "dd/MM/yyyy HH:mm", "dd/MM/yyyy hh:mm tt", "dd/MM/yyyy h:mm tt", "dd/MM/yyyy HH:mm:ss" };
